...
% In this programme, cos(omega) to cos(200 * omega) are expanded as polynomials relating with only cos(omega). 
% Please feel free to adjust the expansion number below.
expand_num = 200; 
...
% Using the expanded polynomials to construct combined polynomials: cos((k-1) * omega) - cos(k * omega).
